...
import AccordionAnalytics from "./components/accordion/analytics.mjs";
import BreadcrumbAnalytics from "./components/breadcrumbs/analytics.mjs";
import CheckboxesAnalytics from "./components/checkboxes/analytics.mjs";
import DetailsAnalytics from "./components/details/analytics.mjs";
import ErrorSummary from "./components/error-summary/analytics.mjs";
import FileInputDroppable from "./components/file-input/analytics.mjs";
import FooterAnalytics from "./components/footer/analytics.mjs";
import GalleryAnalytics from "./components/gallery/analytics.mjs";
import GlobalHeaderAnalytics from "./components/global-header/analytics.mjs";
import HeaderAnalytics from "./components/header/analytics.mjs";
import HeroAnalytics from "./components/hero/analytics.mjs";
import PictureAnalytics from "./components/picture/analytics.mjs";
import RadiosAnalytics from "./components/radios/analytics.mjs";
import SearchFieldAnalytics from "./components/search-field/analytics.mjs";
import SidebarAnalytics from "./components/sidebar/analytics.mjs";
import TextInputAnalytics from "./components/text-input/analytics.mjs";
import TextareaAnalytics from "./components/textarea/analytics.mjs";
